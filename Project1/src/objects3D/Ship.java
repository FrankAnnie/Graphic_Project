...
public class Ship {
	...
	public void DrawShip() 
 {
		...
		Point4f vertices[] = {  new Point4f(-2.0f, -1.0f, -0.5f, 0.0f), 
								new Point4f(-2.0f, -1.0f, 0.5f, 0.0f),
								new Point4f(-3.0f, 1.0f, -1.0f, 0.0f), 
								new Point4f(-3.0f, 1.0f, 1.0f, 0.0f),
								new Point4f(0.5f, -1.0f, -0.5f, 0.0f),
								new Point4f(0.5f, -1.0f, 0.5f, 0.0f),
								new Point4f(3.0f, 1.0f, -1.0f, 0.0f), 
								new Point4f(3.0f, 1.0f, 1.0f, 0.0f) };

		int faces[][] = { 	{ 0, 4, 5, 1 },//up 
							{ 0, 2, 6, 4 }, 
							{ 0, 1, 3, 2 }, 
							{ 4, 6, 7, 5 },
							{ 1, 5, 7, 3 },
